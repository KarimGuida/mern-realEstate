...
const handleSubmit = async (e) => {
  ...
  return (
    ...
    <div className='flex gap-4'>
      <input disabled={uploading} onChange={(e) => setFiles(e.target.files)} className='p-3 border border-gray-300 rounded w-full' type='file' id='images' accept='images/*' multiple />
